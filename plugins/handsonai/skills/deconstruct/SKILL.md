...
- **Signpost each phase transition.** Announce each phase in one short line as you reach it ("Phase 6 of 13 — mapping the sequence", inside the chapter you announced) so the user always knows where they are.
