...
| ChatGPT web (Pro/Business/Enterprise) | handsonai plugin via Plugins > Add marketplace, or Personal Skill upload (same ZIP) | GitHub connector | generate-and-commit |
