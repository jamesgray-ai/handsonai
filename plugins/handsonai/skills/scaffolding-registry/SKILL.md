...
|---|---|---|---|
| Claude Code | handsonai plugin | local clone | write mode |
| Cowork | handsonai plugin (installed once, shared with Claude Chat) or skill ZIP | repo folder as project | write mode |
