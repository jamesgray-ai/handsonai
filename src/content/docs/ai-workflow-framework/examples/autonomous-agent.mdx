...
description: "A worked example of multi-agent orchestration — Claude Code delegates to four specialist agents to research, write, edit, and publish, with human approval."
---
