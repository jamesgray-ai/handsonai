...
|-------|------|-------------|--------|
| `meeting-prep-researcher` | Agent | Researches attendees and companies, produces a meeting prep brief | [View on GitHub](https://github.com/jamesgray-ai/handsonai/blob/main/examples/agent-gallery/agents/meeting-prep-researcher.md) |
| `preparing-meeting-briefs` | Skill | Step-by-step research workflow for the agent to follow | [View on GitHub](https://github.com/jamesgray-ai/handsonai/tree/main/examples/agent-gallery/skills/preparing-meeting-briefs) |
