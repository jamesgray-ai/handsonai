...
Using a different tool (VS Code Copilot, Perplexity, or another platform)? See [How to Add Skills to Your Platform](../../agentic-building-blocks/skills/#how-to-install-skills) for additional platforms.
