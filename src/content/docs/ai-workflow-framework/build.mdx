...
1. **"Claude builds it"** — The model generates all artifacts (skills, agents, prompts, configs) based on the approved spec and places them where they belong. This is the recommended default.
