...
- If you're cloning as an automation or hosted agent rather than yourself, it needs a [fine-grained personal access token](../github-setup/#later-give-an-agent-or-tool-access-optional), not `gh auth login`
