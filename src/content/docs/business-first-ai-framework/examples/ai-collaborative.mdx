...
- [Deterministic Automation Workflow Example](./deterministic-automation.mdx) — when AI follows fixed rules with no judgment needed
- [Autonomous Agent Workflow Example](./autonomous-agent.mdx) — when AI executes end-to-end with minimal supervision
