---
title: Research
description: "AI use cases for research — searching, synthesizing, and structuring information from multiple sources into briefs and reports, with example workflows."
---
