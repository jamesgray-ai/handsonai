...
short_answer: "Name skills using a gerund verb-noun pattern that describes the action and its context, like 'writing-workflow-sops' or 'indexing-registry', so the name alone tells you what the skill does."
platforms: [claude]
topic: agents
date: 2026-02-02
author: James Gray
