...
| `/handsonai:scaffolding-registry` | Stand up your registry bundle — SCHEMA.md and a first real Workflow node |
...
All 14 skills work fully across Claude Code, Claude Chat, and Cowork — via the plugin or a ZIP upload.
