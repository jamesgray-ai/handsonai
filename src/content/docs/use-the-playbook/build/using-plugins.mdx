...
Plugins install in Chat exactly as they do in Cowork, and a plugin's skills then work in both:
...
Plugins installed here also work in Claude Chat (the skills, at least — hooks and sub-agents are Cowork-only), and plugins installed in Chat appear in Cowork. Step-by-step with screenshots: [Set Up the Skills — Claude](/ai-workflow-framework/skills/#claude-chat--cowork).
...
- **Upload to Claude Chat** — upload a skill ZIP under Customize → Skills ([detailed instructions](#upload-a-plugin-skill-to-claudeai))
