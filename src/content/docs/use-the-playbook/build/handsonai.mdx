...
description: "The handsonai plugin — the AI Workflow Framework, AI Registry, and feature-spec toolkit in a single install for Claude, ChatGPT, Codex, and Claude Code."
---
