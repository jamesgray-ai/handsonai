...
description: Everything you need to design, build, and document AI workflows. The Business-First AI Framework, AI registry, and feature-spec toolkit in a single Claude Code plugin.
---
...
**Full documentation:** [The Business-First AI Framework](../../../business-first-ai-framework/) walks through the methodology with worked examples for each step.
