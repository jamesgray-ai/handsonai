...
| **[ChatGPT](https://help.openai.com/en/articles/20001066-skills-in-chatgpt)** | ✅ Native | **Plugins → Skills** (ZIP upload) or **Plugins → Add marketplace** | Skills run in **Work** (`@skill`) and Codex (`$skill`); plugin skills work in Chat too. Upload on paid plans except Free/Go; plugins on Pro/Business/Enterprise; Enterprise/Edu admins enable Skills |
