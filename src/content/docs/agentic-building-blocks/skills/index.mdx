---
title: Skills
description: "The Skill building block — reusable routines the AI discovers and loads on demand when relevant to a task, so your best workflows run the same way every time."
---
...
| **[ChatGPT](https://help.openai.com/en/articles/20001066-skills-in-chatgpt)** | ✅ Native | **Plugins → Skills** (ZIP upload) or **Plugins → Add marketplace** | Skills run in **Work** (`@skill`) and Codex (`$skill`); plugin skills work in Chat too. Upload on paid plans except Free/Go; plugins on any paid plan; Enterprise/Edu admins enable Skills |
...
| **[Gemini Spark](https://support.google.com/gemini/answer/17094296)** | ✅ Native | **Skills → Upload** in Spark mode | Personal Google Accounts with Google AI Pro/Ultra (not work/school accounts); web, Mac app, and mobile; sidebar **Switch to Spark**; `/skill` to invoke |
