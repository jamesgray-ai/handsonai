...
Your [Design phase](../../../../ai-workflow-framework/design/) produced a platform-agnostic agent blueprint. Here's how each component maps to a Claude Code agent file:
...
Your [Design phase](../../../../ai-workflow-framework/design/) produced a platform-agnostic agent blueprint. Here's how each component maps to the Agent SDK:
