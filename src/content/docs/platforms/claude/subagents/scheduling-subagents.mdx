...
description: "Set up Claude Code subagents to run automatically on a schedule using launchd on macOS or Task Scheduler on Windows — wrapper scripts, logging, and testing."
---
